...
import mieco from "../../assets/img-projects/mieco.png";
import ImageComponent from "../ImageComponent";

const images = [
	{ url: "https://mieco.netlify.app/", image: mieco, alt: "" },
	{ url: "https://icumbres.netlify.app/", image: icumbres, alt: "" },
	{ url: "https://mytreelink.netlify.app/", image: treelink, alt: "" },
	{ url: "https://minetflix.netlify.app/", image: netflix, alt: "" },
	{ url: "https://misgastosapp.netlify.app/", image: igastos, alt: "" },
	{ url: "https://iclima.netlify.app/", image: iclima, alt: "" },
	{ url: "https://clon-disneyplus.netlify.app/", image: disney, alt: "" },
	{ url: "https://ramdonquotegenerator.netlify.app/", image: quotes, alt: "" },
	{ url: "https://calculadorarex.netlify.app/", image: calculator, alt: "" },
];
		...
		<SectionProjects id="proyectos">
			...
			<GridContainer>
				{images.map(({ url, image, alt }) => (
					<ImageComponent key={url} url={url} image={image} alt={alt} />
				))}
			</GridContainer>
		</SectionProjects>
	);
